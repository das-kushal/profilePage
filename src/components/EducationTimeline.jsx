...
const AnimatedVerticalTimelineElement = ({ date, title, content, icon, location, pos,place }) => {
    ...
    return (
        ...
        >
            <VerticalTimelineElement
                date={date} // Keep the date as a string
                dateClassName="date"
            ...
            >
                <h3 className="vertical-timeline-element-title" style={{ color: '#000', fontWeight: "bold", fontSize: '1.2rem' }}>
                    {title}
                </h3>
